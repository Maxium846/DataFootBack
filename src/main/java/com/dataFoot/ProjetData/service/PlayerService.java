...
private final PlayerStatRepository playerStatRepository;
    ...
    public PlayerService(PlayersRepository playerRepository, ClubRepository clubRepository, MatchEventRepository eventRepo, PlayerStatRepository playerStatRepository) {
    ...
    public PlayerStatDto getPlayerStats(int playerId) {
        ...
        int assists = eventRepo.countAssists(
                playerId,
                List.of(EventType.GOAL));        int total = eventRepo.findByPlayerId(playerId).size();

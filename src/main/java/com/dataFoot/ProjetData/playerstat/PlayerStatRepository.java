...
public interface PlayerStatRepository extends JpaRepository<PlayerStats, Long> {
    ...
    @Query("""
                SELECT new com.dataFoot.ProjetData.playerstat.playerstatdto.PlayerStatOffensiveDto(
                    ps.player.id,
                    ps.player.name,
                    ps.teams.name,
                    ps.teams.id,
                ...
                GROUP BY ps.player.id, ps.player.name, ps.teams.name, ps.teams.id, ps.teams.logo
    ...
    @Query("""
                SELECT new com.dataFoot.ProjetData.playerstat.playerstatdto.PlayerStatPasseDto(
                    ps.player.id,
                    ps.player.name,
                    ps.teams.name,
                    ps.teams.id,
    ...
    @Query("""
                SELECT new com.dataFoot.ProjetData.playerstat.playerstatdto.PlayerStatImpactDto(
                    ps.player.id,
                    ps.player.name,
                    ps.teams.name,
                    ps.teams.id,
